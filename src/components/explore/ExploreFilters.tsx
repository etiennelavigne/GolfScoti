...
export function ExploreFilters({ isMobile = false }: ExploreFiltersProps) {
    if (isMobile) {
        return (
    ...
    return (
        <div className="p-6 flex flex-col gap-8">
            <div className="flex justify-between items-center">
                ...
                <button className="text-sm font-semibold text-neutral-500 hover:text-neutral-900 underline decoration-neutral-300 underline-offset-4">Clear All</button>
            </div>
                ...
                <div className="flex flex-col gap-2">
                    {["Fife & St Andrews", "The Highlands", "Lothians & Edinburgh", "Ayrshire & West"].map(region => (
                        <label key={region} className="flex items-center gap-2 font-medium text-sm text-neutral-700 cursor-pointer hover:text-neutral-900 group">
                            <input type="checkbox" className="w-4 h-4 rounded border-neutral-300 text-[#2dc653] focus:ring-[#2dc653] transition-colors" />
                            {region}
                        </label>
                    ))}
                </div>
            ...
            <div className="flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-bold text-[#2dc653]">£250</span>
                </div>
                <input
                    type="range"
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-16">
                        <input type="number" placeholder="12.4" className="w-full px-2 py-1.5 bg-neutral-100 rounded text-sm text-center font-bold border border-transparent focus:border-[#2dc653] outline-none" />
                    </div>
                </div>
            </div>
